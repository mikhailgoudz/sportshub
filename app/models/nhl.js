...
export default Model.extend({
    ...
    AwayTeamMoneyLine: DS.attr('string'),
    HomeTeam: DS.attr('string'),
    HomeTeamMoneyLine: DS.attr('string'),
    ...
    HomeLogo : computed ('HomeTeam',function(){
    ...
    AwayLogo : computed ('AwayTeam',function(){
        ...
        switch(this.get('AwayTeam')){
            ...
            case "ND": return "https://user-images.githubusercontent.com/43256526/69587849-afae3a80-0f9b-11ea-9c4b-39e45edb395f.png";  
